...
class App extends Component {
  ...
  renderContent = () => {
    ...
    switch(mode) {
      case 'main':
        return <Modes account={account} payroll={payroll} web3={web3} />
  //    case 'file':
  //      return <FileInput account={account} payroll={payroll} web3={web3} />
    ...
    return (
      <Layout>
        <Header className="header">
          <div className="logo">OKNC-空投ERC20代币系统</div>
          <Menu
            theme="dark"
            mode="horizontal"
          ...
          >
            <Menu.Item key="main">主界面</Menu.Item>
